...
-(IBAction)play:(id)sender{
    ...
    NSURL *movieURL = [NSURL URLWithString:@"http://prepronokalgroupappcom.hostings.nexica.net/pnkv/nutricion.mp4"];  // sample url
    ...
    NSURL *url = [NSURL URLWithString:@"http://prepronokalgroupappcom.hostings.nexica.net/pnkv/nutricion.mp4"];
